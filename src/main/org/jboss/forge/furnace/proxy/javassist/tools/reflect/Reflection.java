...
import org.jboss.forge.furnace.proxy.javassist.CtMethod.ConstParameter;
 ...
 * @see org.jboss.forge.furnace.proxy.javassist.tools.reflect.Loader
...
public class Reflection implements Translator {
    ...
    static final String metaobjectClassName = "org.jboss.forge.furnace.proxy.javassist.tools.reflect.Metaobject";
    ...
    public void start(ClassPool pool) throws NotFoundException {
        classPool = pool;
        final String msg
            = "org.jboss.forge.furnace.proxy.javassist.tools.reflect.Sample is not found or broken.";
        try {
            CtClass c = classPool.get("org.jboss.forge.furnace.proxy.javassist.tools.reflect.Sample");
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtClass mlevel = classPool.get("org.jboss.forge.furnace.proxy.javassist.tools.reflect.Metalevel");
        ...
        CtField f;
        if (addMeta) {
            f = new CtField(classPool.get("org.jboss.forge.furnace.proxy.javassist.tools.reflect.Metaobject"),
        ...
        f = new CtField(classPool.get("org.jboss.forge.furnace.proxy.javassist.tools.reflect.ClassMetaobject"),
