    ...
    protected CtField fieldAccess(ASTree expr) throws CompileError {
        if (expr instanceof Member) {
            ...
            if (op == MEMBER) {
                 ...
                 *
                 * class Foo {
                 *   int org.jboss.forge.furnace.proxy.javassist;
                 * }
                 *
                 * It is impossible to add the following method:
                 *
                 * String m() { return org.jboss.forge.furnace.proxy.javassist.CtClass.intType.toString(); }
                 *
                 * because org.jboss.forge.furnace.proxy.javassist is a field name.  However, this is
