...
import org.jboss.forge.furnace.proxy.javassist.convert.*;

/**
 * Simple translator of method bodies
 * (also see the <code>org.jboss.forge.furnace.proxy.javassist.expr</code> package).
 *
 ...
 *
 * @see org.jboss.forge.furnace.proxy.javassist.CtClass#instrument(CodeConverter)
 * @see org.jboss.forge.furnace.proxy.javassist.CtMethod#instrument(CodeConverter)
 * @see org.jboss.forge.furnace.proxy.javassist.expr.ExprEditor
 */
public class CodeConverter {
     ...
     * @see org.jboss.forge.furnace.proxy.javassist.CtMethod#setName(String)
     */
