...
package org.jboss.forge.furnace.proxy.javassist.tools.rmi;
...
public class StubGenerator implements Translator {
    ...
    private static final String sampleClass = "org.jboss.forge.furnace.proxy.javassist.tools.rmi.Sample";
     ...
     * This is a method declared in org.jboss.forge.furnace.proxy.javassist.Translator.
     *
     * @see org.jboss.forge.furnace.proxy.javassist.Translator#start(ClassPool)
     */
    public void start(ClassPool pool) throws NotFoundException {
        ...
        proxyConstructorParamTypes
            = pool.get(new String[] { "org.jboss.forge.furnace.proxy.javassist.tools.rmi.ObjectImporter",
                                         "int" });
        interfacesForProxy
            = pool.get(new String[] { "java.io.Serializable",
                                         "org.jboss.forge.furnace.proxy.javassist.tools.rmi.Proxy" });
        exceptionForProxy
            = new CtClass[] { pool.get("org.jboss.forge.furnace.proxy.javassist.tools.rmi.RemoteException") };
    }

    /**
     * Does nothing.
     * This is a method declared in org.jboss.forge.furnace.proxy.javassist.Translator.
     * @see org.jboss.forge.furnace.proxy.javassist.Translator#onLoad(ClassPool,String)
     */
        ...
        throws CannotCompileException, NotFoundException
    {
        ...
        CtField f
            = new CtField(classPool.get("org.jboss.forge.furnace.proxy.javassist.tools.rmi.ObjectImporter"),
                          fieldImporter, proxy);
