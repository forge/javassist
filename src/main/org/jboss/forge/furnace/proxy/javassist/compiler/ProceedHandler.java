...
import org.jboss.forge.furnace.proxy.javassist.compiler.ast.ASTList;

/**
 * An interface to an object for implementing $proceed().
 *
 * @see org.jboss.forge.furnace.proxy.javassist.compiler.JvstCodeGen#setProceedHandler(ProceedHandler, String)
 * @see org.jboss.forge.furnace.proxy.javassist.compiler.JvstCodeGen#atMethodCall(Expr)
 */
