 ...
 * with previous releases of org.jboss.forge.furnace.proxy.javassist. Unfortunately,this legacy behaviour makes caching
 * and reuse of proxy classes impossible. The current programming model expects org.jboss.forge.furnace.proxy.javassist
 ...
 * to serialize and deserialize, respectively, the proxy. These streams recognise org.jboss.forge.furnace.proxy.javassist proxies and ensure
...
public class ProxyFactory {
    ...
    private static final String NULL_INTERCEPTOR_HOLDER = "org.jboss.forge.furnace.proxy.javassist.util.proxy.RuntimeSupport";
     ...
     * setting retains the old org.jboss.forge.furnace.proxy.javassist behaviour which has the advantage that it
    ...
    /**
     * determine if a class is a org.jboss.forge.furnace.proxy.javassist proxy class
     * @param cl
     * @return true if the class is a org.jboss.forge.furnace.proxy.javassist proxy class otherwise false
     */
    ...
    protected ClassLoader getClassLoader0() {
        ...
        if (loader == null) {
            ...
            // In case org.jboss.forge.furnace.proxy.javassist is in the endorsed dir
            if (loader == null) {
    ...
    private static MethodInfo makeWriteReplace(ConstPool cp) {
        ...
        code.addAload(0);
        code.addInvokestatic("org.jboss.forge.furnace.proxy.javassist.util.proxy.RuntimeSupport",
                             "makeSerializedProxy",
