...
package org.jboss.forge.furnace.proxy.javassist.tools.web;
 ...
 *
 * <ul><code>% java org.jboss.forge.furnace.proxy.javassist.tools.web.Viewer <i>host port</i> Main arg1, ...</code></ul>
 *
 ...
 * <code>org.jboss.forge.furnace.proxy.javassist.*</code> classes are not needed at the client side.
...
public class Viewer extends ClassLoader {
    ...
    public static void main(String[] args) throws Throwable {
        if (args.length >= 3) {
            ...
            System.err.println(
        "Usage: java org.jboss.forge.furnace.proxy.javassist.tools.web.Viewer <host> <port> class [args ...]");
    }
    ...
    protected Class findClass(String name) throws ClassNotFoundException {
        ...
        if (name.startsWith("java.") || name.startsWith("javax.")
            || name.equals("org.jboss.forge.furnace.proxy.javassist.tools.web.Viewer"))
