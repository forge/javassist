 ...
 *
 * @see org.jboss.forge.furnace.proxy.javassist.CtClass#instrument(ExprEditor)
 * @see org.jboss.forge.furnace.proxy.javassist.CtMethod#instrument(ExprEditor)
 * @see org.jboss.forge.furnace.proxy.javassist.CtConstructor#instrument(ExprEditor)
 * @see MethodCall
 * @see NewExpr
 * @see FieldAccess
 *
 * @see org.jboss.forge.furnace.proxy.javassist.CodeConverter
 */
