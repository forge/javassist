...
public class JvstCodeGen extends MemberCodeGen {
    ...
    public void atMember(Member mem) throws CompileError {
        ...
        if (name.equals(paramArrayName)) {
            ...
            bytecode.addInvokestatic("org.jboss.forge.furnace.proxy.javassist/runtime/Desc", "getParams",
    ...
    private void callGetType(String method) {
        bytecode.addInvokestatic("org.jboss.forge.furnace.proxy.javassist/runtime/Desc", method,
                                "(Ljava/lang/String;)Ljava/lang/Class;");
        exprType = CLASS;
        arrayDim = 0;
        className = "java/lang/Class";
    ...
    protected void atCflow(ASTList cname) throws CompileError {
        ...
        bytecode.addInvokevirtual("org.jboss.forge.furnace.proxy.javassist.runtime.Cflow",
                                  "value", "()I");
        exprType = INT;
        arrayDim = 0;
        className = null;
