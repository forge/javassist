...
package org.jboss.forge.furnace.proxy.javassist.bytecode.stackmap;
...
public class MapMaker extends Tracer {
    ...
    public static void main1(String className) throws Exception {
        ...
        //org.jboss.forge.furnace.proxy.javassist.CtClass cc = cp.get(className);
        org.jboss.forge.furnace.proxy.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(className));
    ...
    public static void main2(String[] args) throws Exception {
        ClassPool cp = ClassPool.getDefault();
        //org.jboss.forge.furnace.proxy.javassist.CtClass cc = cp.get(args[1]);
        org.jboss.forge.furnace.proxy.javassist.CtClass cc = cp.makeClass(new java.io.FileInputStream(args[1]));
        MethodInfo minfo;
