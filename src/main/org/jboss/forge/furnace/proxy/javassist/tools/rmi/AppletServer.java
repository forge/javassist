 ...
 *
 * @see org.jboss.forge.furnace.proxy.javassist.tools.rmi.ObjectImporter
 */
public class AppletServer extends Webserver {
     ...
     *
     * @see org.jboss.forge.furnace.proxy.javassist.tools.rmi.ObjectImporter#lookupObject(String)
     */
