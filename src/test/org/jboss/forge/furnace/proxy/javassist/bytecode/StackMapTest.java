...
import org.jboss.forge.furnace.proxy.javassist.CtNewConstructor;
import org.jboss.forge.furnace.proxy.javassist.CtNewMethod;
import org.jboss.forge.furnace.proxy.javassist.JvstTest;
...
import org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTable;
import org.jboss.forge.furnace.proxy.javassist.bytecode.stackmap.MapMaker;
import org.jboss.forge.furnace.proxy.javassist.bytecode.stackmap.TypeData;
...
public class StackMapTest extends TestCase {
    ...
    public void testCommonSuper() throws Exception {
        CtClass type = loader.get("org.jboss.forge.furnace.proxy.javassist.CtClassType[]");
        CtClass base = loader.get("org.jboss.forge.furnace.proxy.javassist.CtClass[]");
        CtClass array = loader.get("org.jboss.forge.furnace.proxy.javassist.CtArray[]");
        CtClass array2 = loader.get("org.jboss.forge.furnace.proxy.javassist.CtArray[][]");
    ...
    public void testRebuild() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T1");
        rebuildStackMaps2(cc);
        //Class c = cc.toClass();
    ...
    public void testRebuild2() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$C3");
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testRebuild3() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T3");
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testRebuildArray() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T4");
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testRebuildConstructor() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T5");
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testRebuildConstructor2() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T6");
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testSwitchCase() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T7");
        ...
        cc.getDeclaredMethod("test2").setBody(loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T8").getDeclaredMethod("test2"), null);
        //rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void testSwitchCase2() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T7b");
        StringBuffer sbuf = new StringBuffer("String s;");
        for (int i = 0; i < 130; i++)
            sbuf.append("s =\"" + i + "\";");

        cc.getDeclaredMethod("foo").insertBefore(sbuf.toString());
        cc.getDeclaredMethod("test2").setBody(loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T8b").getDeclaredMethod("test2"), null);
        rebuildStackMaps2(cc);
        cc.writeFile();
        Object t1 = make(cc.getName());
        assertEquals(110, invoke(t1, "test"));
    ...
    public void testSwitchCase3() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T7c");
        StringBuffer sbuf = new StringBuffer("String s;");
        for (int i = 0; i < 130; i++)
            sbuf.append("s =\"" + i + "\";");

        cc.getDeclaredMethod("foo").insertBefore(sbuf.toString());
        cc.getDeclaredMethod("test2").setBody(loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T8c").getDeclaredMethod("test2"), null);
    ...
    public void testSwitchCase4() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T8e");
        StringBuffer sbuf = new StringBuffer("String s;");
        for (int i = 0; i < 130; i++)
            sbuf.append("s =\"" + i + "\";");

        cc.getDeclaredMethod("foo").insertBefore(sbuf.toString());
        CtClass orig = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T8d");
    ...
    public void testInnerClass() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T9");
        CtClass par = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T9$Parent");
        CtClass in = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$T9$In");
        rebuildStackMaps2(cc);
    ...
    public void testConstructor3() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$C4");
    ...
    public void testJIRA175() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$C5");
        cc.getDeclaredMethod("setter").instrument(new org.jboss.forge.furnace.proxy.javassist.expr.ExprEditor() {
            @Override
            public void edit(org.jboss.forge.furnace.proxy.javassist.expr.FieldAccess f) throws org.jboss.forge.furnace.proxy.javassist.CannotCompileException {
    ...
    public void testJIRA175b() throws Exception {
        CtClass cc = loader.get("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest$C6");
        try {
            cc.getDeclaredMethod("setter").instrument(new org.jboss.forge.furnace.proxy.javassist.expr.ExprEditor() {
                public void edit(org.jboss.forge.furnace.proxy.javassist.expr.FieldAccess f) throws org.jboss.forge.furnace.proxy.javassist.CannotCompileException {
                    if (!f.where().getMethodInfo().isMethod())
        ...
        catch (org.jboss.forge.furnace.proxy.javassist.CannotCompileException e) {}
    }
    ...
    public void testForHibernate() throws Exception {
        ClassFile cf = loader.makeClass("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTestHibTest").getClassFile();
    ...
    public void testJsr() throws Exception {
        CtClass cc = loader.makeClass("org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTestJsrTest");
        ...
        cc.addMethod(CtMethod.make("public static void main(String[] args) {"
                                 + "new org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTestJsrTest().test();"
                                 + "}",
                                   cc));
        cc.writeFile();
        Object t1 = make(cc.getName());
    ...
    public void tstCtClassType() throws Exception {
        ...
        CtClass cc = cp.get("org.jboss.forge.furnace.proxy.javassist.CtClassType");
