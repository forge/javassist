...
public final class InsertGap0 extends JvstTestRoot {
    ...
    public void testExample() throws Throwable {
        ...
        CtClass cc = pool.get("org.jboss.forge.furnace.proxy.javassist.bytecode.Gap0Example");
    ...
    public void testExample2() throws Throwable {
        ClassPool pool = ClassPool.getDefault();
        CtClass cc = pool.get("org.jboss.forge.furnace.proxy.javassist.bytecode.Gap0Example2");
        CtMethod[] ms = cc.getDeclaredMethods();
        for (int i = 0; i < ms.length; i++) {
            addMethod(ms[i], cc);
        }
