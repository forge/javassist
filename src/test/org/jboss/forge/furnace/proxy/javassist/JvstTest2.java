...
import org.jboss.forge.furnace.proxy.javassist.ByteArrayClassPath;
...
import org.jboss.forge.furnace.proxy.javassist.ClassPoolTail;
...
import org.jboss.forge.furnace.proxy.javassist.LoaderClassPath;
import org.jboss.forge.furnace.proxy.javassist.Modifier;
import org.jboss.forge.furnace.proxy.javassist.NotFoundException;
import org.jboss.forge.furnace.proxy.javassist.URLClassPath;
...
public class JvstTest2 extends JvstTestRoot {
    ...
    private void notTestGetInner() throws Exception {
        ...
        CtClass c = pool.get("org.jboss.forge.furnace.proxy.javassist.CtMethod.ConstParameter");
        CtClass d = pool.get("org.jboss.forge.furnace.proxy.javassist.CtMethod.ConstParameter");
        CtClass e = pool.get("org.jboss.forge.furnace.proxy.javassist.CtMethod$ConstParameter");
        assertSame(c, d);
        assertSame(c, e);
        try {
    ...
    public void testURL() throws Exception {
        ...
        cp = new ClassPool(null);
        cp.insertClassPath(JAR_PATH + "org.jboss.forge.furnace.proxy.javassist.jar");

        url = cp.find("org.jboss.forge.furnace.proxy.javassist.CtClass").toString();
        System.out.println(url);
        assertTrue(url.startsWith("jar:file:"));
        assertTrue(url.endsWith("org.jboss.forge.furnace.proxy.javassist.jar!/org.jboss.forge.furnace.proxy.javassist/CtClass.class"));

        assertNull(cp.find("org.jboss.forge.furnace.proxy.javassist.TestURL"));

        cp = new ClassPool(null);
        cp.insertClassPath(new LoaderClassPath(cloader));

        url = cp.find("org.jboss.forge.furnace.proxy.javassist.CtMethod").toString();
        System.out.println(url);
        // assertTrue(url.startsWith("jar:file:"));
        // assertTrue(url.endsWith("org.jboss.forge.furnace.proxy.javassist.jar!/org.jboss.forge.furnace.proxy.javassist/CtMethod.class"));
    ...
    public void testToString() throws Exception {
        ...
        System.out.println(sloader.get("org.jboss.forge.furnace.proxy.javassist.CtNewClass"));
    }
