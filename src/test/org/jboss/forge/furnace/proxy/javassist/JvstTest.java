...
import org.jboss.forge.furnace.proxy.javassist.ClassPath;
...
import org.jboss.forge.furnace.proxy.javassist.Modifier;
import org.jboss.forge.furnace.proxy.javassist.NotFoundException;
import org.jboss.forge.furnace.proxy.javassist.SerialVersionUID;
import org.jboss.forge.furnace.proxy.javassist.bytecode.*;
import org.jboss.forge.furnace.proxy.javassist.expr.*;
import org.jboss.forge.furnace.proxy.javassist.runtime.*;

public class JvstTest extends JvstTestRoot {
    static {
        //org.jboss.forge.furnace.proxy.javassist.bytecode.MethodInfo.doPreverify = true;
    }
    ...
    public void testLoader() throws Exception {
        ...
        assertEquals(loader.loadClass("test1.Cflow").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("org.jboss.forge.furnace.proxy.javassist.Loader").getClassLoader(),
                     loader.getParent());
        assertEquals(loader.loadClass("org.jboss.forge.furnace.proxy.javassist.CtClass").getClassLoader(),
                     loader);
    }
    ...
    public static Test suite() {
        ...
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.bytecode.BytecodeTest.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.bytecode.StackMapTest.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.compiler.CompTest.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.SetterTest.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.bytecode.InsertGap0.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.tools.reflect.LoaderTest.class);
        suite.addTestSuite(testproxy.ProxyTester.class);
        suite.addTestSuite(testproxy.ProxyFactoryPerformanceTest.class); // remove?
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.proxyfactory.ProxyFactoryTest.class);
        suite.addTestSuite(org.jboss.forge.furnace.proxy.javassist.proxyfactory.Tester.class);
