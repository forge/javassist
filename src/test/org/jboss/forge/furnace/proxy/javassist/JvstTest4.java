...
import org.jboss.forge.furnace.proxy.javassist.ClassMap;
...
public class JvstTest4 extends JvstTestRoot {
    ...
    private void testAnalysisType2(CtClass cc, int size) throws Exception {
        org.jboss.forge.furnace.proxy.javassist.bytecode.analysis.Type t = org.jboss.forge.furnace.proxy.javassist.bytecode.analysis.Type.get(cc);
    ...
    public void testJIRA150b() throws Exception {
        int origSize = org.jboss.forge.furnace.proxy.javassist.compiler.MemberResolver.getInvalidMapSize();
        int N = 100;
        for (int k = 0; k < N; k++) {
            ClassPool pool = new ClassPool(true);
            for(int paths=0; paths<50; paths++) {
        ...
        System.gc();
        System.gc();
        int size = org.jboss.forge.furnace.proxy.javassist.compiler.MemberResolver.getInvalidMapSize();
    ...
    public void testJIRA151() {
        ...
        assertTrue(org.jboss.forge.furnace.proxy.javassist.runtime.Desc.getClazz("[Ljava.lang.String;") != null);
        //Thread.currentThread().setContextClassLoader(TestDescForName.class.getClassLoader());
        boolean old = org.jboss.forge.furnace.proxy.javassist.runtime.Desc.useContextClassLoader;
        org.jboss.forge.furnace.proxy.javassist.runtime.Desc.useContextClassLoader = true;
        assertTrue(org.jboss.forge.furnace.proxy.javassist.runtime.Desc.getClazz("[Ljava.lang.String;") != null);
        org.jboss.forge.furnace.proxy.javassist.runtime.Desc.useContextClassLoader = old;
    }
